...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-users-cog"></i> Clasificación de Clientes</h1>
    <p class="mb-4">Listado de categorias de clientes, puede creaer los tipos de clientes en función a clasificación que vea conveniente</p>

    <div class="card shadow mb-4">
        <div class="card-header py-3"><i class="fa fa-fw fa-globe"></i> <strong>Listado de Tipos</strong>

            {{--				<h6 class="m-0 font-weight-bold text-primary">Listado de servicios</h6>--}}


            <a href="{{route("tiposclientes.create")}}" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i>
                Agregar tipo</a></div>
        ...
        <div class="row  my-2">
            ...
            <div class="col-sm-12 col-md-4 " >
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 " action="{{route("tipocliente.buscar")}}" method="POST" role="search">
                        {{ csrf_field() }}
                        <div class="input-group">


                            <input type="text" class="form-control bg-light border-0 small" placeholder="descripcion del articulo..." aria-label="Search" aria-describedby="basic-addon2" name="Descripcion">
                                ...
                                @foreach($tiposclientes as $tipocliente)
                                    <tr role="row">
                                        ...
                                        <td class="sorting_1">
                                            ...
                                            <li data-form="#delete-form-{{$tipocliente->IdTipoCliente}}"
                                                data-title="Eliminar Tipo"
                                                data-message="Se encuentra seguro de eliminar esta clasificación?"
                                                data-target="#formConfirm" class="listado">



                                                <a class="btn btn-primary " class="formConfirm text-primary"
                                                   href="{{route("tiposclientes.edit", $tipocliente->IdTipoCliente )}}"
                                                   aria-label="Editar">
                                            ...
                                            <form id="delete-form-{{$tipocliente->IdTipoCliente}}"

                                                  action = "{{route("tiposclientes.destroy", $tipocliente->IdTipoCliente )}}" method="post"
                                                  style="display: none">
