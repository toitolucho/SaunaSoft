...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-dolly"></i> Proveedores</h1>
    <p class="mb-4">Se muestra el listado de empresas que son proveedores del Sauna</p>

    <div class="card shadow mb-4">
        <div class="card-header py-3"><i class="fa fa-fw fa-globe"></i> <strong>Listado de Proveedores</strong>

            {{--				<h6 class="m-0 font-weight-bold text-primary">Listado de servicios</h6>--}}


            <a href="{{route("proveedores.create")}}" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i>
                Agregar proveedor</a></div>

        <div class="row  my-2">
            <div class="col-sm-12 col-md-8"></div>
            <div class="col-sm-12 col-md-4 " >

                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 " action="{{route("proveedor.buscar")}}" method="POST" role="search">
                        {{ csrf_field() }}
                        <div class="input-group">


                            <input type="text" class="form-control bg-light border-0 small" placeholder="descripcion del proveedor..." aria-label="Search" aria-describedby="basic-addon2" name="NombreProveedor">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="w-30 text-center">Proveeodr</th>
                                    <th class="w-20 text-center">Representante</th>
                                    <th class="w-20 text-center">Direccion</th>
                                    <th class="w-5 text-center">Telefono</th>
                                ...
                                @foreach($proveedores as $proveedor)
                                    <tr role="row">
                                        ...
                                        <td >{{$proveedor->NroCelular}}</td>

                                        <td class="sorting_1">

                                            <li data-form="#delete-form-{{$proveedor->IdProveedor}}"
                                                data-title="Eliminar Proveedor"
                                                data-message="Se encuentra seguro de eliminar este Proveedor?"
                                            ...
                                            <form id="delete-form-{{$proveedor->IdProveedor}}"

                                                  action = "{{route("proveedores.destroy", $proveedor->IdProveedor )}}" method="post"
                                                  style="display: none">
