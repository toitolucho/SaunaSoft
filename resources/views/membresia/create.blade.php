    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-header"><i class="fa fa-fw fa-plus-circle">
                ...
                <a href="{{route("membresias.index")}}" class="float-right btn btn-dark btn-sm"><i
                        class="fa fa-fw fa-globe"></i> Listado de Membresia</a>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{route("membresias.store")}}" method="POST" id="formMembresia">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="search" name="NombreCliente" class="form-control typeahead"
                                   placeholder="Cliente" autocomplete="off" id="textoCliente" required
                        ...
                        <div class="form-row col-md-12">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="CostoGeneral" id="CostoGeneral" class="form-control"
                                       placeholder="Ingrese Costo General" required value="{{old('CostoGeneral')}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary">
                                <i class="fa fa-fw fa-plus-circle"></i> Agregar Membresia
                            </button>
                        </div>
