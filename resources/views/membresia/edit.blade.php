    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-header"><i class="fa fa-fw fa-plus-circle">
                ...
                <a href="/categorias" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Listado de Membresias</a>
            </div>
                        ...
                        <form action="{{route("membresias.update", $membresia->IdMembresia)}}" method="POST">
                            ...
                            <div class="form-row col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="FechaInicio" id="FechaInicio" class="form-control" placeholder="Ingrese La Fecha Inicio" required value="{{ \Carbon\Carbon::parse($membresia->FechaInicio)->format('Y-m-d')}}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputState">Fecha Final<span class="text-danger">*</span></label>
                                    <input type="date" name="FechaFin" id="FechaFin" class="form-control" placeholder="Ingrese La Fecha Final" required   value="{{ \Carbon\Carbon::parse($membresia->FechaFin)->format('Y-m-d')}}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="CostoGeneral" id="CostoGeneral" class="form-control" placeholder="Ingrese Costo General" required  value="{{$membresia->CostoGeneral}}">
                                </div>

                                <div class="form-group">
                                    <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Actualizar Membresia</button>
                                </div>
                            </div>
