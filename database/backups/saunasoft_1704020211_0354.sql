...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2021 at 09:53 PM
...
(3, 1, '2020-12-31 09:28:39', 'F', NULL, 'aaaaa');
...
--
ALTER TABLE `comprasarticulos`
  MODIFY `IdCompraArticulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ventasservicio`
  MODIFY `IdVentaServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
